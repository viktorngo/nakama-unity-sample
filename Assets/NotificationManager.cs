...
public class NotificationManager : MonoBehaviour
{
    ...
    public float checkInterval = 5f; // Adjust as needed
    ...
    {
        // if (Time.time - lastNotificationCheck >= checkInterval)
        // {
        //     Debug.Log("checking notifications...");
        //     lastNotificationCheck = Time.time;
        //
        //     // NakamaConnection.ReceiveNotification();
        //     var notifications = await NakamaConnection.LoadMoreNotifications();
        //     
        //     if (notifications != null)
        //     {
        //         Debug.Log("received notifications: " + notifications.Count);
